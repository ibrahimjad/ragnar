...
NPy = out.y1.Data(:,1);
NPz = out.z1.Data(:,1);
NPphi = out.phi1.Data(:,1);
NPxT = out.x1.Time;
NPyT = out.y1.Time;
NPzT = out.z1.Time;
NPphiT = out.phi1.Time;
...
P1 = plot(NPxT,NPx,'b',out.x1.Time,out.x1.Data(:,1),'r--');
set(P1,'linewidth',lw);
...
P2 = plot(NPyT,NPy,'b',out.y1.Time,out.y1.Data(:,1),'r--');
set(P2,'linewidth',lw);
...
P3 = plot(NPzT,NPz,'b',out.z1.Time,out.z1.Data(:,1),'r--');
set(P3,'linewidth',lw);
...
P4 = plot(NPphiT,NPphi,'b',out.phi1.Time,out.phi1.Data(:,1),'r--');
set(P4,'linewidth',lw);
