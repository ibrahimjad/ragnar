...
P1 = plot(ans.Time,ans.Data(:,2),'b',ans.Time,ans.Data(:,4),'r',ans.Time,ans.Data(:,1),'k:');

set(P1,'linewidth',lw);
set(P1(2),'linewidth',rlw);
ylabel('x [Meters]');
ylim([-0.011 0.013]);
legend("No network",'Network','Reference','Location','southwest','AutoUpdate','off');
...
P2 = plot(ans.Time,ans.Data(:,6),'b',ans.Time,ans.Data(:,8),'r',ans.Time,ans.Data(:,5),'k:');
set(P2,'linewidth',lw);
...
P3 = plot(ans.Time,ans.Data(:,10),'b',ans.Time,ans.Data(:,12),'r',ans.Time,ans.Data(:,9),'k:');
set(P3,'linewidth',lw);
...
P4 = plot(ans.Time,ans.Data(:,14),'b',ans.Time,ans.Data(:,16),'r',ans.Time,ans.Data(:,13),'k:');
set(P4,'linewidth',lw);
