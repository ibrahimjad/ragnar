...
C5 = (C1+C2)/2
C6 = (C3+C4)/2
JG5=jacobian(C2,[x y z ph])
JG6=jacobian(C4,[x y z ph])
...
AM(5,5) = thet5
AM(6,6) = thet6
BM=[(B1-C1)'*JG1;(B2-C2)'*JG2;(B3-C3)'*JG3;(B4-C4)'*JG4;C5'*JG5;C6'*JG6];
%J=BM\AM;
...
theta_5_pwr_on = sqrt(t5(1)^2+t5(2)^2+t5(3)^2)
theta_6_pwr_on = sqrt(t6(1)^2+t6(2)^2+t6(3)^2)
