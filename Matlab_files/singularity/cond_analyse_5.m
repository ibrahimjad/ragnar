...
alpha = 0; beta = 0; l = 0.3 % inner link
L = 0.6; % outer link length
% rx = leg(7);
% ry = leg(8);
% rz = leg(9);
%h_d = leg(10);
...
R = Rz(alpha) * Ry(beta) * Rz(thet5);
A = [a; b; 0];
S = R * (l*ii);
B5 = A+S;
JF5=jacobian(B5,[thet1 thet2 thet3 thet4 thet5])

C5 = [x y z]' + Rx(ph)*h_all(:,2) + r_a;
JG5=jacobian(C5,[x y z ph])

%---------------total matrix
AM=[(B1-C1)'*JF1;(B2-C2)'*JF2;(B3-C3)'*JF3;(B4-C4)'*JF4;(B5-C5)'*JF5];
BM=[(B1-C1)'*JG1;(B2-C2)'*JG2;(B3-C3)'*JG3;(B4-C4)'*JG4;(B5-C5)'*JG5];
J=AM\BM;
...
JN=JNum(phi_pwr_on,thetas_pwr_on(1),thetas_pwr_on(2),thetas_pwr_on(3),thetas_pwr_on(4),sol(2),x_pwr_on,y_pwr_on,z_pwr_on)
cond(JN)



AMN=AMNum(phi_pwr_on,thetas_pwr_on(1),thetas_pwr_on(2),thetas_pwr_on(3),thetas_pwr_on(4),sol(2),x_pwr_on,y_pwr_on,z_pwr_on);
BMN=BMNum(phi_pwr_on,thetas_pwr_on(1),thetas_pwr_on(2),thetas_pwr_on(3),thetas_pwr_on(4),sol(2),x_pwr_on,y_pwr_on,z_pwr_on);
JNN=BMN\AMN;
cond(JNN)
