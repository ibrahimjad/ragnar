...
BM=[(B1-C1)'*JG1;(B2-C2)'*JG2;(B3-C3)'*JG3;(B4-C4)'*JG4;D'*JG5];
%J=BM\AM;
...
%%
hold on
arm5 = [x_pwr_on;y_pwr_on;z_pwr_on]
A=[0 x_pwr_on];
B=[0 y_pwr_on];
C=[0 z_pwr_on];
plot3(A,B,C,'k-','LineWidth',3,'color','red')
